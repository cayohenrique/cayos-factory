...
- at most two complete rounds per gate.
...
Grill interviewer and interviewee must follow `skills/cayos-factory-auto-mode/references/final-feature-bar.md`: default to **final production feature** scope. MVP/prototype/spike/POC shortcuts are forbidden unless explicitly stated in the ticket snapshot or orchestrator prompt.
