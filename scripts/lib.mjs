...
export const states = ["PREFLIGHT","TICKET_RESOLVED","PREPARING","UNDERSTANDING_PENDING","TEST_SEAM_PENDING","PLAN_PENDING","READY_TO_IMPLEMENT","IMPLEMENTING","REVIEWING","VERIFYING","READY_FOR_PR","OPENING_PR","DONE","BLOCKED","ABORTED"];
export const transitions = {
  PREFLIGHT:["TICKET_RESOLVED","BLOCKED","ABORTED"], TICKET_RESOLVED:["PREPARING","UNDERSTANDING_PENDING","BLOCKED","ABORTED"],
  PREPARING:["IMPLEMENTING","BLOCKED","ABORTED"],
  ...
  VERIFYING:["IMPLEMENTING","REVIEWING","READY_FOR_PR","BLOCKED","ABORTED"], READY_FOR_PR:["OPENING_PR","VERIFYING","ABORTED"],
